...
<html>
    ...
    <body style="background-image: url('${pageContext.request.contextPath}/resources/images/GymGeneral.jpg'); background-size: cover; background-position: center; background-attachment: fixed;">
        <div class="main-container registration-container">
            ...
            <form action="${pageContext.request.contextPath}/registerUser" method="POST" enctype="multipart/form-data" onsubmit="return checkData(event)">
                ...
                <!-- Campo desplegable para seleccionar el rol -->
                <label for="role">Tipo de Usuario:</label>
                <select id="role" name="role" required>
                    <option value="Usuario" ${param.role == 'Usuario' ? 'selected' : ''}>Usuario</option>
